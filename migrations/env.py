...
# The database URL comes from ragbridge Settings (environment variables /
# .env), never from alembic.ini, so Alembic always connects to the same
# database as the running app.
config.set_main_option("sqlalchemy.url", get_settings().database_url)

# Models' metadata, used by 'alembic revision --autogenerate'.
